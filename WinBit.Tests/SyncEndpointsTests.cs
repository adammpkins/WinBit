...
public sealed class SyncEndpointsTests : IAsyncLifetime
{
    ...
    public SyncEndpointsTests()
    {
        ...
        _service = new WebUiService(Settings, new WebUiAuthService(Settings), _session,
            ...
            new StubRssService(), new StubAutoDownloaderService(), new StubRssArticleCache(), new StubRssRefresher(), new WinBit.Core.BitTorrent.TorrentCreatorQueue(new WinBit.Core.BitTorrent.TorrentCreatorService()), TestPaths.Ambient);
    }
